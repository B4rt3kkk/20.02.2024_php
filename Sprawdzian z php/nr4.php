...
<head>
    ...
    <body>
        ...
        <?php
            ...
            $counter_records = $conn->query("SELECT COUNT(czujniki.ID) as 'ile' FROM czujniki WHERE KATEGORIA = 4;" );
        ...
        <?php
            ...
            $counter_records = $conn->query("SELECT MAX(czujniki.CENACZUJNIKA) as 'najdroższe' FROM czujniki WHERE KATEGORIA < 500;" );
        ...
        <div class="nr4">
            ...
            <?php
                ...
                $all_records = $conn->query("SELECT czujniki.ID,czujniki.CENACZUJNIKA,czujniki.NAZWA,czujniki.KATEGORIA FROM czujniki WHERE KATEGORIA = 4" );
